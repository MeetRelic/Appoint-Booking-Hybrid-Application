...
class _EM1 extends State<EM1Meet> with SingleTickerProviderStateMixin {
  ...
  //     onPressed: () {
  //       ClipboardManager.copyToClipBoard("kdcsoaksdaos").then((result) {
