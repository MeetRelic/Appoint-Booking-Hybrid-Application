...
class MenuDashboardPage12 extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    // TODO: implement build
    return MaterialApp(
      title: 'HOME',
      home: MenuDashboardPage2(),
    );
  }
}
...
class MenuDashboardPage2 extends StatefulWidget {
  @override
  _MenuDashboardPageState1 createState() => _MenuDashboardPageState1();
}

class _MenuDashboardPageState1 extends State<MenuDashboardPage2>
    with SingleTickerProviderStateMixin {
  final _rate = Rating();
  final _checker = DynamChecker();
  final _dates = DynamDates('');
  String initials = globals.initials;
                                                            ...
                                                            showDialog(
                                                                ...
                                                                builder:
                                                                  ...
                                                                  return AlertDialog(
                                                                    ...
                                                                    content:
                                                                        new Text(
                                                                      'We are yet to recieve the payment as mentioned in letter of engagement mailed to you.\n If you wish to engage us further, please make the payment and mail confirmation scrrenshot on finplan@vivekdamani.com.Click Yes to check Bank Details.',
                                                                      textAlign:
                                                                          TextAlign
                                                                              .start,
                                                                      style: TextStyle(
          ...
          child: SingleChildScrollView(
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: <Widget>[
                  Text(
                    "Joyful Life Questionnaire",
                    textAlign: TextAlign.center,
                    style: TextStyle(color: Colors.black, fontSize: 14),
                  ),
                  SizedBox(height: 5),
                  //On a scale of 1 to 100 (1 being least satisfied and 100 being most satisfied

                  Text(
                    "To help us Understand you better please fill in the below questionnaire ,On a Scale of 1 to 100 (1 being least satisfied and 100 being most satisfied)",
                    style: TextStyle(color: Colors.black, fontSize: 14),
                  ),
                  ...
                  Text(
                    "How would you rate your health ? (${value1.toString().trim().split(".")[0]})%",
                  ...
                  SizedBox(height: 20),
                  Text(
                    " How would you rate your health related life-style ? (${value2.toString().trim().split(".")[0]})%",
                    style: TextStyle(color: Colors.black, fontSize: 15),
                  ),
                  ...
                  SizedBox(height: 20),
                  Text(
                    "How would you rate your work ? (${value3.toString().trim().split(".")[0]})%",
                    style: TextStyle(color: Colors.black, fontSize: 15),
                  ),
                  new Slider(
                    value: value3,
                  ...
                  SizedBox(height: 20),
                  Text(
                    "How would you rate your cash-flows ? (${value4.toString().trim().split(".")[0]})%",
                    style: TextStyle(color: Colors.black, fontSize: 15),
                  ),
                  new Slider(
                    value: value4,
                  ...
                  SizedBox(height: 20),
                  Text(
                    "How would you rate your family-life ? (${value5.toString().trim().split(".")[0]})%",
                    style: TextStyle(color: Colors.black, fontSize: 15),
                  ),
                  new Slider(
                    value: value5,
                  ...
                  SizedBox(height: 20),
                  Text(
                    "How would you rate your social/community life ? (${value6.toString().trim().split(".")[0]})%",
                    style: TextStyle(color: Colors.black, fontSize: 15),
                  ),
                  new Slider(
                    value: value6,
                  ...
                  SizedBox(height: 20),
                  Text(
                    "How would you rate your eagerness to learn ? (${value7.toString().trim().split(".")[0]})%",
                    style: TextStyle(color: Colors.black, fontSize: 15),
                  ),
                  new Slider(
                    value: value7,
                  ...
                  Text(
                    "How would you rate your eagerness to teach ? (${value8.toString().trim().split(".")[0]})%",
                    style: TextStyle(color: Colors.black, fontSize: 15),
                  ),
                  new Slider(
                    value: value8,
  ...
  void saving(int valu1, int valu2, int valu3, int valu4, int valu5, int valu6,
      int valu7, int valu8) async {
    Dialogs.showLoadingDialog(context, _keyLoader);
    await _rate.save(valu1, valu2, valu3, valu4, valu5, valu6, valu7, valu8);
    var rat = await _rate.savebody();
    Navigator.of(_keyLoader.currentContext, rootNavigator: true).pop();
    print(rat);
    if (rat.toString().contains("Succ")) {
      showDialog(
          context: context,
          builder: (BuildContext context) {
            // return object of type Dialog
            return AlertDialog(
              ...
              title: new Text(" Ratings Saved !"),
              content: new Text(
                'Great Work ' +
                    globals.name.split(" ")[0] +
                    '.\nWe are now starting this journey based on the questionnaire. \n check the graph by clicking okay below.',
                textAlign: TextAlign.start,
                style: TextStyle(fontFamily: 'Arial'),
              ),
              actions: <Widget>[
                new FlatButton(
                  ...
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => new DSB()),
                    );
                    //.of(context).pop();
                  },
                ),
    ...
    } else if (rat.toString().contains("exis")) {
      showDialog(
          context: context,
          builder: (BuildContext context) {
            // return object of type Dialog
            return AlertDialog(
              title: new Text(" NOTE "),
              content: new Text(
                'Response already Present,Please Click "Okay" Button below to Conitue',
                textAlign: TextAlign.start,
                style: TextStyle(fontFamily: 'Arial'),
              ),
              actions: <Widget>[
    ...
    //   NavigaNavitor.push(context, new MaterialPageRoute(builder: (context) =>new MenuDashboardPage14()),);
  }
  ...
  void _onchanged4(double value) {
    setState(() {
      value4 = value;
    });
  }

  void _onchanged5(double value) {
    setState(() {
      value5 = value;
    });
  }

  void _onchanged6(double value) {
    setState(() {
      value6 = value;
    });
  }

  void _onchanged7(double value) {
    setState(() {
      value7 = value;
    });
  }

  void _onchanged8(double value) {
    setState(() {
      value8 = value;
    });
  }
