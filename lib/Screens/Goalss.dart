...
class Gsp extends StatelessWidget {
  @override
...
class _EM extends State<E1Meet> with SingleTickerProviderStateMixin {
  ...
  Widget dashboard(context) {
    ...
    String jsonSample = '[{"id":1},{"id":2}]';
    var json = jsonDecode(jsonSample);
    var goalstable = globals.goalsdatatable;

//.toString().replaceAll("[", "").replaceAll("]", "");
    final List<Map<String, String>> listOfPetrol = globals.goalsdatatable;
                                  ...
                                  ((element) => DataRow(
                                        cells: <DataCell>[
                                          DataCell(
                                            ...
                                            // onTap: () {
                                            //   print(element["goalamt"]);
                                            // }
                                          ),
                                          DataCell(
                                            Text(element["goalyear"]),
                                          ),
                                          DataCell(
                                            Text(element["goalamt"]),
                                          ),
                                          DataCell(
                                            Text(element["Achvdamt"]),
                                          ),
                                          DataCell(
                                            Text(element["status"]),
                                          ),
...
// child: JsonTable(listOfPetrol,rowHighlightColor: Colors.red,)
// ),
                ],
              ),
            ),
