...
class CDAT extends StatelessWidget {
  @override
...
class _EM extends State<E1Meet> with SingleTickerProviderStateMixin {
  ...
  Widget get getsbutton {
    if (t1 != null && _dateTime != null) {
      return new FlatButton(
          ...
          onPressed: () async {
            ...
            var rec = await _ots.sendcustom(_dateTime.toString().split(" ")[0],
                t1.toString().split("(")[1].replaceAll(")", ""));
            Navigator.of(_keyLoader.currentContext, rootNavigator: true).pop();
            if (rec.toString().contains("Success")) {
              showDialog(
                  context: context,
                  builder: (BuildContext context) {
                    // return object of type Dialog
            ...
            // print(t1.toString().split("(")[1].replaceAll(")", ""));
          });
    }
  }
