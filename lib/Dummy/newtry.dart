...
class MenuDashboardPage24 extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'HOME',
      home: MenuDashboardPage131(),
          );
        }
      }

class MenuDashboardPage131 extends StatefulWidget {
   
  @override
  _MenuDashboardPageState311 createState() => _MenuDashboardPageState311();

}

class _MenuDashboardPageState311 extends State<MenuDashboardPage131> with SingleTickerProviderStateMixin {
  final _rate=Rating();
...
//                     new Text("How Much Would you rate yourself on fitness?? ${value1.toString().trim().split(".")[0]} %", style: TextStyle(color: Colors.white, fontSize: 15),),
...
//                             ),
                    ...
                    //                                            },
                    //                                          )  , ),       
//                                   child:  new Container(height: 200,width:300 , 
